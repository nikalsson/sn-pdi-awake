...
/** don't server pages via 'express' when running on home server, uncomment if you want to host a page containing the logs
...
const RESToperations = require("./lib/RESTOperations"), // Functions that handle the communication with the instance
...
/** don't server pages via 'express' when running on home server
